import { Activity, ArrowRight, CloudRain, MapPinned, Siren, Wifi } from "lucide-react";
...
export default function WelcomeScreen({ onContinue }) {
  return <main className="welcome-screen">
    ...
    <header className="welcome-top"><div className="welcome-logo"><span><img src="/disasterai-logo.png" alt="DisasterAI"/></span><div><strong>DisasterAI</strong><small>EARLY WARNING NETWORK</small></div></div><div className="welcome-online"><i/> Network live</div></header>
